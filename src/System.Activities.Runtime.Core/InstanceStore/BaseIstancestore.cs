...
namespace System.Activities.Runtime.Core.DurableInstancing
{
    public class BaseIstancestore : InstanceStore, IStoreCorrelation
    {
        private IstancestoreDelegates delegates = null;

        public WorkflowCorrelation Correlation { get; set; }
